...
var xxx = prompt(" 输入时间转换比 "); //获取输入的转换比
var xxx = parseInt(xxx); //将输入的转换比转化为数值
document.tett.timexxx.value = xxx; //将转换比显示在输入框中
var starttime = prompt(" 输入开始的时间戳(刚才你记下来的） "); //获取输入的初始时间戳
var starttime = parseInt(starttime); //将输入的初始时间戳转化为数值
document.tett.start.value = starttime; //将初始时间戳显示在输入框中
</script>
